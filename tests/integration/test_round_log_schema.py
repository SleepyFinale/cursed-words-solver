...
@pytest.mark.parametrize(
    ("solver_available", "path_matches", "predicted", "actual", "expected"),
    [
        (False, False, 0, 0, "no_suggestion"),
        (True, False, 100, 100, "path_mismatch"),
        (True, True, 100, 90, "score_mismatch"),
        (True, True, 100, 100, "score_match"),
    ],
)
